...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "Blog",
          description: "Blog posts and articles by Julien Arino.",
          section: "Navigation",
          handler: () => {
          ...
          title: "Projects",
          description: "A growing collection of projects and software.",
          section: "Navigation",
          handler: () => {
          ...
          title: "People",
          description: "Current members of the Arino group in alphabetical order of last name. See also former members and alumni.",
          section: "Navigation",
          handler: () => {
        ...
        description: "Notes de cours d&#39;un cours d&#39;épidémiologie mathématique donné à N&#39;Djaména.",
        section: "Posts",
        handler: () => {
        ...
        description: "Lecture notes and videos of the 3MC short course on Mathematical Epidemiology.",
        section: "Posts",
        handler: () => {
        ...
        description: "Compendium of commands useful in Marp for presentations.",
        section: "Posts",
        handler: () => {
        ...
        description: "How to use Marp to make nice looking presentation slides.",
        section: "Posts",
        handler: () => {
        ...
        description: "Comments on and Rmarkdown source code of the paper Mathematical epidemiology in a data-rich world.",
        section: "Posts",
        handler: () => {
        ...
        handler: () => {
          ...
          description: "Un petit cours d&#39;épidémiologie mathématique enseigné en novembre 2025 à N&#39;Djaména.",
          section: "Teaching",handler: () => {
