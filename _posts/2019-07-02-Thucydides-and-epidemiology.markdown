...
The part in my slide above is the first mention of the plague ([Book II.48](http://www.perseus.tufts.edu/hopper/text?doc=Perseus:text:1999.01.0200:book=2:chapter=48)).
...
Finally, Thucydides concludes with the Hellenistic version of the mic drop..
