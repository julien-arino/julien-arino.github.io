...
description: "A simple but working example of using parLapply in R to perform a very basic sensitivity analysis."
...
When working with students and postdocs, I often provide "skeletons", i.e., pieces of code that illustrate something that I want them to do in another context. Case in point: running some code in parallel. Here, I will carry out a very simple and naive sensitivity analysis of the value of the basic reproduction number {% raw %}$R_0${% endraw %} in the basic Kermack and McKendrick SIR model.
